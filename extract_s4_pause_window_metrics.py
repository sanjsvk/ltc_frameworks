"""
Extract pause window MAPE (weeks 100-120) for all models on S4 scenario.

Requires: Fitted models from S4, or ability to refit.
"""
...
def compute_pause_window_metrics(model_name: str, scenario: str = "S4"):
    """Fit model on S4 and compute pause-window MAPE."""
...
print("=" * 120)
print("PAUSE WINDOW MAPE EXTRACTION (S4, Weeks 100-120)")
print("=" * 120)
print()
...
for model in models:
    ...
    metrics = compute_pause_window_metrics(model, "S4")
    if metrics:
