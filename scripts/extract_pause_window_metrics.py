"""
Extract pause window MAPE (weeks 100-120) for all models on S2 scenario.

Requires: Fitted models from S2, or ability to refit.
"""
...
def compute_pause_window_metrics(model_name: str, scenario: str = "S2"):
    """Fit model on S2 and compute pause-window MAPE."""
...
print("=" * 120)
print("PAUSE WINDOW MAPE EXTRACTION (S2, Weeks 100-120)")
print("=" * 120)
print()
...
for model in models:
    ...
    metrics = compute_pause_window_metrics(model, "S2")
    if metrics:
