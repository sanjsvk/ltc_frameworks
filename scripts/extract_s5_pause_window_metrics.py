"""
Extract pause window MAPE (weeks 100-120) for all models on S5 scenario.

Requires: Fitted models from S5, or ability to refit.
"""
...
def compute_pause_window_metrics(model_name: str, scenario: str = "S5"):
    """Fit model on S5 and compute pause-window MAPE."""
...
print("=" * 120)
print("PAUSE WINDOW MAPE EXTRACTION (S5, Weeks 100-120)")
print("=" * 120)
print()
...
for model in models:
    ...
    metrics = compute_pause_window_metrics(model, "S5")
    if metrics:
